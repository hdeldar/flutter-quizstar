...
class _quizpageState extends State<quizpage> {
  ...
  String getData(int i, String j){
    String d;
    //print( " i : " + i.toString() + " j : " + j);
    d = mydata[i][j];
    //debugPrint(d);
    if(d == null)
      d = "";
  ...
  String getData2(int i, String j, String k){
    String d;
    //print( " i : " + i.toString() + " j : " + j+ " k : " + k);
    d = mydata[i][j][k];
    //debugPrint(d);
    if(d == null)
      d = "";
  ...
  void checkanswer(String k) {
    ...
    if (getData(2, i.toString()) == getData2(1,i.toString(),k)) {
